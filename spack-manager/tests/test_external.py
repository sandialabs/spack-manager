...
import manager.cmd.manager_cmds
import manager.cmd.manager_cmds.external
import pytest
    ...
    with tmpdir.as_cwd():
        ...
        with pytest.raises(SystemExit):
            with ev.Environment("test"):
                manager.cmd.manager_cmds.external.external(None, args)
...
def evaluate_external(tmpdir, yaml_file):
    ...
    with ev.Environment("test") as e:
        ...
        with patch(
            "manager.cmd.manager_cmds.external.write_spec",
